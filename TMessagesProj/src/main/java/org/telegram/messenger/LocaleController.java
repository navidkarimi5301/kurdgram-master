...
public class LocaleController {
    ...
    public LocaleController() {
        addRules(new String[]{"bem", "brx", "da", "de", "el", "en", "ku", "eo", "es", "et", "fi", "fo", "gl", "he", "iw", "it", "nb",
      ...
      localeInfo = new LocaleInfo();
        localeInfo.name = "کردی";
        localeInfo.nameEnglish = "Kurdi";
        ...
        try {
            ...
            String lang = preferences.getString("language", "ku");
            if (lang != null) {
            ...
            if (currentInfo == null) {
                currentInfo = languagesDict.get("ku");
            }
        ...
        try {
            ...
            if (newLocale != null) {
                ...
                if (currentPluralRules == null) {
                    currentPluralRules = allRules.get("ku");
                }
